...
Many researchers [use word processors for analysis](https://www.slideshare.net/jennacondie/working-with-word-for-qualitative-data-analysis) to analyse qualitative data, since they are wide spread and flexible. 
